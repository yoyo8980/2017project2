...
public class ScoreDao {
	...
	public ArrayList<ScoreDto> scoreSubject(){ //�ڵ� �輺��
	...
	public void insertScoreCall (ArrayList<String> scorecall,String subject){ //�ڵ� �輺��/ ���� ������
...
//			rs=pstmt.executeQuery();
//			if(rs.next()){				
//				scoreid=Integer.toString(rs.getInt("SCOREID")+1);//Id ��ȣ �ڵ��ο� 	
//			}
	...
	public ArrayList<ScoreDto> scoreView(String stuname,int stuid){ //�ڵ� �輺��
	...
	public void edit(ArrayList paramList) throws SQLException{ //�ڵ� �輺��
		int scoCnt=0;
		int pstCnt=0;
		int score;
		int scoreid;
